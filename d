...
local ApA = {
    ...
    Background = Color3.fromRGB(18, 10, 28),             -- 짙은 보라색 (메인 바탕)
    Topbar = Color3.fromRGB(25, 12, 38),                 -- 짙은 보라색 (상단바)
    ...
    TabStroke = Color3.fromRGB(0, 230, 100),             -- 초록색 (탭 테두리)
    TabBackgroundSelected = Color3.fromRGB(45, 20, 70),
    TabTextColor = Color3.fromRGB(180, 160, 200),
    SelectedTabTextColor = Color3.fromRGB(255, 60, 60),  -- 탭 선택 텍스트 (빨강)
    ElementBackground = Color3.fromRGB(24, 12, 36),       -- 짙은 보라색 (요소 배경)
    ElementBackgroundHover = Color3.fromRGB(38, 18, 58),
    SecondaryElementBackground = Color3.fromRGB(16, 8, 25),
    ElementStroke = Color3.fromRGB(0, 230, 100),         -- 초록색 (메인 겉테두리)
    SecondaryElementStroke = Color3.fromRGB(0, 180, 80), -- 초록색 (보조 테두리)
    SliderBackground = Color3.fromRGB(30, 15, 45),
    SliderProgress = Color3.fromRGB(220, 30, 30),         -- 빨강색 (슬라이더)
    SliderStroke = Color3.fromRGB(255, 60, 60),
    ToggleBackground = Color3.fromRGB(25, 12, 38),
    ToggleEnabled = Color3.fromRGB(230, 30, 30),          -- 빨강색 (토글 켜짐)
    ToggleEnabledStroke = Color3.fromRGB(255, 80, 80),   -- 빨강색 (토글 테두리)
    ToggleEnabledOuterStroke = Color3.fromRGB(160, 20, 20),
    ToggleDisabled = Color3.fromRGB(45, 25, 65),
    ToggleDisabledStroke = Color3.fromRGB(0, 180, 80),   -- 초록색 (토글 꺼짐 테두리)
    ...
    InputStroke = Color3.fromRGB(0, 230, 100),           -- 초록색 (입력창 테두리)
